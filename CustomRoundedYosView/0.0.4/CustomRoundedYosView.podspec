Pod::Spec.new do |spec|
  ...
  spec.name         = "CustomRoundedYosView"
  spec.version      = "0.0.4"
  ...
  spec.homepage     = "https://github.com/YosuaMarchel/CustomCorner"
  ...
  spec.author             = { "yosuamarchel" => "yosua.marchel@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/YosuaMarchel/CustomCorner.git", :tag => "#{spec.version}" }
