...
//  BeautyShape
//
//  Created by Yosua Marchel on 20/10/20.
...
public class CustomRounded {
    ...
    public static func roundedTopRightTopLeft(view: UIView) {
        ...
        view.layer.maskedCorners = [.layerMaxXMinYCorner, .layerMaxXMaxYCorner] // Bottom right corner, Bottom left corner respectively
    }
